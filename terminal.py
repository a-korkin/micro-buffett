...
class Graph:
    ...
    def draw_axes(self):
        ...
        # _min = min(self.minc.open, self.minc.close, self.minc.high, self.minc.low)
        # _max = max(self.maxc.open, self.maxc.close, self.maxc.high, self.maxc.low)
        self.draw_scale_y()
